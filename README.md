...
- Adjustable driving personality profiles via the "Distance" button on the steering wheel (GM/Lexus/Toyota only)
...
- Model selector to easily swap driving models
