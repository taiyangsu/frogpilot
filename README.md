...
🛠 **Device Behaviors:**
  ...
  - Customizable device auto-shutdown timer to prevent battery drain
...
🚘 **Driving Behaviors:**
  ...
  - Lateral Adjustments:
    ...
    - [Pfeiferj's curvature adjustment](https://github.com/commaai/openpilot/pull/28118) for better curve handling
  ...
  - Longitudinal Adjustments:
    ...
    - Vision Turn Speed Controller for safe curve navigation
      - With customizable speed aggressiveness and curve detection sensitivity
  - Toggle Experimental Mode via the "Lane Departure Alert" button (Toyota/Lexus) or by double tapping the screen
------
🚗 **Driving Personality Profiles:**

  - Ability to completely customize the following distance for each profile
  - Adjustable via the "Distance" button on the steering wheel (Supported: GM/Lexus/Toyota)
...
🚦 **Other Quality of Life Features:**
  ...
  - Green light alert for light changes
...
[Join the FrogPilot Community Discord for easy access to updates, bug reporting, feature requests, future planned updates, and other FrogPilot related discussions!](https://discord.gg/n8XFfTN3SB)
