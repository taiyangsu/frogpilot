...
class LongitudinalMpc:
  ...
  def update(self, radarstate, v_cruise, x, v, a, j, custom_personalities, aggressive_follow, standard_follow, relaxed_follow, personality=log.LongitudinalPersonality.standard):
