...
FrogPilotNavigationPanel::FrogPilotNavigationPanel(QWidget *parent) : FrogPilotPanel(parent) {
  ...
  ButtonControl *instructionsButton = new ButtonControl(tr("Mapbox Instructions"), "", tr("VIEW"), this);
  instructionsButton->setText(tr("VIEW"));
  QObject::connect(instructionsButton, &ButtonControl::clicked, this, &FrogPilotNavigationPanel::displayInstructions);
  primelessLayout->addWidget(instructionsButton);
...
void FrogPilotNavigationPanel::displayInstructions() {
...
FrogPilotVisualsPanel::FrogPilotVisualsPanel(QWidget *parent) : FrogPilotPanel(parent) {
  ...
  static const std::vector<std::tuple<QString, QString, QString, QString>> toggles = {
    {"CameraView", "Camera View (Cosmetic Only)", "Set your preferred camera view for the onroad UI. This toggle is purely cosmetic and will not affect openpilot's use of the other cameras.", "../assets/icon_camera.png"},
