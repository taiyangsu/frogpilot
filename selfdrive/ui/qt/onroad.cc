...
void AnnotatedCameraWidget::drawLaneLines(QPainter &painter, const UIState *s) {
  ...
  for (int i = 0; i < std::size(scene.road_edge_vertices); ++i) {
    if (frogColors) {
      ...
      painter.setBrush(QColor::fromRgbF(0.75, 1.0, 0, std::clamp<float>(1.0 - scene.road_edge_stds[i], 0.0, 1.0)));
    }
  ...
  if (alwaysOnLateral) {
    ...
    pe.setColorAt(0.0, QColor::fromHslF(73 / 360., 0.94, 0.50, 1.0));
    pe.setColorAt(0.5, QColor::fromHslF(73 / 360., 1.00, 0.60, 0.5));
    pe.setColorAt(1.0, QColor::fromHslF(73 / 360., 1.00, 0.60, 0.1));
  }
  ...
  if ((blindSpotLeft || blindSpotRight) && speedCheck && isNotTurning && is_cruise_set) {
    bs.setColorAt(0.0, QColor::fromHslF(290 / 360., 0.44, 0.50, 0.6));
    bs.setColorAt(0.5, QColor::fromHslF(290 / 360., 0.44, 0.50, 0.4));
    bs.setColorAt(1.0, QColor::fromHslF(290 / 360., 0.44, 0.50, 0.2));
  }
