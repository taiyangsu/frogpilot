...
class CarController:
  ...
  def update(self, CC, CS, now_nanos):
    ...
    if CS.out.standstill and not self.last_standstill and (self.CP.carFingerprint not in NO_STOP_TIMER_CAR or self.CP.enableGasInterceptor) and not CarInterface.sng_hack:
