...
def crash_log(candidate):
  ...
  control_keys, vehicle_keys, visual_keys = [
    "AlwaysOnLateral", "AlwaysOnLateralMain", "ConditionalExperimental", "ConditionalSpeed", 
    "ConditionalSpeedLead", "ConditionalCurves", "ConditionalCurvesLead", "ConditionalSlowerLead", "ConditionalStopLights", 
    "ConditionalSignal", "CustomPersonalities", "AggressivePersonality", "AggressiveJerk", "StandardPersonality", "StandardJerk", 
    "RelaxedPersonality", "RelaxedJerk", "DeviceShutdownTimer", "DisableOnroadUploads", "ExperimentalModeViaWheel", 
    ...
    "SmootherBraking", "Model", "NudgelessLaneChange", "LaneChangeTimer", "LaneDetection", "OneLaneChange", "PauseLateralOnSignal", "PersonalitiesViaWheel", 
    "TurnDesires", "VisionTurnControl", "CurveSensitivity", "TurnAggressiveness", "DisableInternetCheck", "ReverseCruiseIncrease", "TwilsoncoSSH"
  ], [
