...
def crash_log(candidate):
  ...
  control_keys, vehicle_keys, visual_keys = [
    ...
    "ConditionalSignal", "CustomDrivingPersonalities", "AggressivePersonality", "AggressiveJerk", "StandardPersonality", "StandardJerk", 
    "RelaxedPersonality", "RelaxedJerk", "DeviceShutdownTimer", "DisableOnroadUploads", "DrivingPersonalitiesUIWheel", "ExperimentalModeViaWheel", 
    ...
    "VisionTurnControl", "CurveSensitivity", "TurnAggressiveness", "DisableInternetCheck", "ReverseCruiseIncrease", "TwilsoncoSSH"
  ], [
