...
def crash_log(candidate):
  ...
  control_keys, vehicle_keys, visual_keys = [
    ...
    "ConditionalCurvesLead", "ConditionalSignal", "ConditionalSlowerLead", "ConditionalStopLights", "CustomPersonalities", "AggressivePersonality", 
    "AggressiveJerk", "StandardPersonality", "StandardJerk", "RelaxedPersonality", "RelaxedJerk", "DeviceShutdownTimer", "ExperimentalModeViaWheel", 
    "FireTheBabysitter", "DisableAllLogging", "MuteDM", "MuteDoor", "MuteSeatbelt", "MuteSystemOverheat", "LateralTuning", "AverageDesiredCurvature", 
    "NNFF", "LongitudinalTuning", "AccelerationProfile", "IncreasedStoppingDistance", "AggressiveAcceleration", "SmootherBraking", "Model", 
    "NudgelessLaneChange", "LaneChangeTimer", "LaneDetection", "OneLaneChange", "PauseLateralOnSignal", "PersonalitiesViaWheel", "TurnDesires", 
    "VisionTurnControl", "CurveSensitivity", "TurnAggressiveness", "DisableInternetCheck", "DisableOnroadUploads", "ReverseCruiseIncrease", "TwilsoncoSSH"
  ], [
    "EVTable", "LowerVolt", "SNGHack", "TSS2Tune"
  ], [
    "CustomTheme", "CustomColors", "CustomIcons", "CustomSignals", "CustomSounds", "Compass", "CustomRoadUI", "LaneLinesWidth", "RoadEdgesWidth", 
    "PathWidth", "PathEdgeWidth", "AccelerationPath", "AdjacentPath", "BlindSpotPath", "DisplayFPS", "LeadInfo", "UnlimitedLength", "DriverCamera", 
    "GreenLightAlert", "RotatingWheel", "ScreenBrightness", "Sidebar", "SilentMode", "SteeringWheel", "WideCameraDisable", "DisplayCPU", "DisplayGPU", 
    "DisplayMemoryUsage", "DisplayStorageLeft", "DisplayStorageUsed", "HideSpeed", "NumericalTemp", "Fahrenheit"
  ]
